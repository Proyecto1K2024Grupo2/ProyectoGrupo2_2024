...
public class CirujanoDAO extends EmpleadoDAO {
    ...
    private static final String INSERT_QUERY = "INSERT INTO Cirujano (dni, nombre, telefono, NumeroCuenta, Sueldo) VALUES (?, ?, ?, ?,?)";
    private static final String INSERT_QUERY_EMPLEADO = "INSERT INTO Empleado(dni, nombre, telefono, NumeroCuenta, Sueldo) VALUES (?, ?, ?, ?,?)";
    private static final String SELECT_ALL_QUERY = "SELECT * FROM Cirujano";
    private static final String SELECT_BY_DNI_QUERY = "SELECT * FROM Cirujano WHERE dni = ?";
    private static final String UPDATE_QUERY = "UPDATE Cirujano SET dni = ?, nombre = ?, telefono = ? , NumeroCuenta = ?  WHERE dni = ?";
    private static final String UPDATE_QUERY_EMPLEADO = "UPDATE Cirujano SET dni = ?, nombre = ?, telefono = ? , NumeroCuenta = ?  WHERE dni = ?";
    private static final String DELETE_QUERY = "DELETE FROM Cirujano WHERE dni = ?";
    private static final String DELETE_QUERY_EMPLEADO = "DELETE FROM Cirujano WHERE dni = ?";
    ...
    public List<Cirujano> getAllPersonas() throws SQLException {
     ...
     * @throws SQLException Si ocurre un error en la base de datos.
     */
    public Cirujano getPersonaByDni(String dni) throws SQLException {
     ...
     */
    private Cirujano resultSetToPersona(ResultSet resultSet) throws SQLException {
        return new Cirujano(
